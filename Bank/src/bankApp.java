...
// 2. Create a statement
			...
			if (res.next()) {
				...
				while (flag) {
					...
					case 3:
						...
						if (myRs.next()) {
							...
							String sql5 = ("INSERT INTO `trans`(name,money,bal_amount) VALUE ('" + "venkul" + "','"
									+ 1000 + "','" + bal_amount + "')");
					...
					case 4:
						...
						if (myRs.next()) {
							...
							String sql5 = ("INSERT INTO `trans`(name,money,bal_amount) VALUE ('" + "self" + "','" + 1000
									+ "','" + bal_amount + "')");
							myStmt.executeUpdate(sql5);
				...
				System.out.println("Database is empty, so creating database for you..."); // prints this message if your
																							// resultset is empty
				...
				while (itr1.hasNext()) {
					...
					String sql1 = ("INSERT INTO `trans`(name,money,bal_amount) VALUE ('" + st.name + "','" + st.money
							+ "','" + st.bal_amount + "')");
